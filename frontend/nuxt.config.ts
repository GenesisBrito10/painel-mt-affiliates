  ...
  app: {
    ...
    head: {
      ...
      link: [
        ...
        { key: 'shortcut-icon', rel: 'shortcut icon', type: 'image/x-icon', href: '/vallex-favicon.ico' },
        { key: 'apple-touch-icon', rel: 'apple-touch-icon', type: 'image/png', sizes: '180x180', href: '/vallex-apple-touch-icon.png' },
        { key: 'apple-touch-icon-precomposed', rel: 'apple-touch-icon-precomposed', type: 'image/png', sizes: '180x180', href: '/vallex-apple-touch-icon.png' },
