// Seleciona 133 afiliados aleatorios com link ativo de superbet e sem fraude
// superbet positiva, cadastrando 1 CPA fraude para cada um.
...
const TARGET_COUNT = 133;
const CHANGED_BY_EMAIL = 'admin@vallexgroup.com.br';
const BATCH_ID = 'random-superbet-fraud-133-2026-07-09';
